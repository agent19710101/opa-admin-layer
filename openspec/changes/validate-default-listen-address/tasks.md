...
- [x] define the stricter `controlPlane.defaultListenAddress` contract in OpenSpec proposal/spec deltas
- [x] record the mismatch risk and accepted address shapes in a design note
