...
func Validate(spec Specification) []string {
	...
	for labelKey, labelValue := range spec.ControlPlane.ConfigMapLabels {
		if err := validateKubernetesLabelKey(labelKey); err != nil {
			issues = append(issues, fmt.Sprintf("controlPlane.configMapLabels key %q is invalid: %v", labelKey, err))
		}
		if err := validateKubernetesLabelValue(labelValue); err != nil {
			issues = append(issues, fmt.Sprintf("controlPlane.configMapLabels label %q has invalid value %q: %v", labelKey, labelValue, err))
		}
	}
	...
	for labelKey, labelValue := range spec.ControlPlane.DeploymentLabels {
		if err := validateKubernetesLabelKey(labelKey); err != nil {
			issues = append(issues, fmt.Sprintf("controlPlane.deploymentLabels key %q is invalid: %v", labelKey, err))
		}
		if err := validateKubernetesLabelValue(labelValue); err != nil {
			issues = append(issues, fmt.Sprintf("controlPlane.deploymentLabels label %q has invalid value %q: %v", labelKey, labelValue, err))
		}
	}
	...
	for labelKey, labelValue := range spec.ControlPlane.PodLabels {
		if err := validateKubernetesLabelKey(labelKey); err != nil {
			issues = append(issues, fmt.Sprintf("controlPlane.podLabels key %q is invalid: %v", labelKey, err))
		}
		if err := validateKubernetesLabelValue(labelValue); err != nil {
			issues = append(issues, fmt.Sprintf("controlPlane.podLabels label %q has invalid value %q: %v", labelKey, labelValue, err))
		}
	}
