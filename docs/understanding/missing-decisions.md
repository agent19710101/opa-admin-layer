...
- how a future shared-object `ServiceAccount` model should declare ownership: one plan-scoped manifest per effective name, whether shared topics must agree exactly on annotations/labels, and how conflicts should be surfaced before render
