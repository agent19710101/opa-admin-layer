...
- whether Service metadata control should later expand beyond the planned shared `serviceAnnotations` map into traffic policy knobs, multi-port exposure, or per-topic overrides for ingress, mesh, or load-balancer integration
