...
- whether workload metadata control should later expand beyond shared/topic pod-template `podAnnotations` into deployment-level annotations, pod labels, or other admission-controller integration knobs
