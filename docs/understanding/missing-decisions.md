...
- whether Service metadata control should later expand beyond shared/topic `serviceType`, `externalTrafficPolicy`, `sessionAffinity`, and `serviceAnnotations` into multi-port exposure or deeper ingress/mesh/load-balancer integration
