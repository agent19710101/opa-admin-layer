...
- Autoscaling now covers CPU and memory utilization targets plus stabilization windows, but broader HPA behavior policies, custom metrics, and arbitrary scaling-rule selection still remain outside the current narrow contract.
