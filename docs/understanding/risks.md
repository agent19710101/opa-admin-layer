...
- Autoscaling now covers CPU and memory utilization targets, but broader HPA behavior policies, custom metrics, and stabilization rules still remain outside the current narrow contract.
