...
- Topics now inherit those Service defaults but can override `serviceType`, `externalTrafficPolicy`, and merge `serviceAnnotations` when one workload needs different exposure or controller metadata than the rest of the fleet.
